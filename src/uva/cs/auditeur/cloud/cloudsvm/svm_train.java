...
class svm_train {
	...
	private int nr_fold;
	private BufferedReader scaledData;
	...
	public double do_cross_validation(double C, double g){
		param.C = C;
		param.gamma = g;
	...
	public double do_cross_validation()
	{
		int i;
		int total_correct = 0;
	...
	public void initialize(String argv[]) throws IOException
	{	//return byte array of the model
	...
	public byte[] cloud_run() throws IOException
	{	//return byte array of the model
		model = svm.svm_train(prob,param);
		
		return svm.get_svm_model(model);
	}
	...
	{	
		...
		byte[] model_bytes;
		t.initialize(args);
		model_bytes = t.cloud_run();
//		t.run1(args);
//		t.do_cross_validation();
	}

	public void setData(byte[] bytes) {
		scaledData = Utility.byteArray2Reader(bytes);
	}
