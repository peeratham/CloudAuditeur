...
package uva.cs.auditeur.cloud.cloudsvm.libsvm;
import java.io.*;
import java.util.*;
...
public class svm {
	 ...
	 */
	//modified
	public static byte[] get_svm_model(svm_model model) throws IOException
	{	
...
//		System.out.println(baos.toString());
	...
	/**
	 * added to load model from file
	 * @param path
	 * @return
	 * @throws FileNotFoundException
	 * @throws IOException
	 */
	public static svm_model svm_load_model_from_file(String path) throws FileNotFoundException, IOException 
	{//for testing
		ByteArrayOutputStream baos = new ByteArrayOutputStream();
		copy(new FileInputStream(path), baos,1024);
		byte[] bytes = baos.toByteArray();
		BufferedReader br = byteArray2Reader(bytes);
		return svm_load_model(br);
	}
	/**
	 * added to load model from byte array
	 * @param model
	 * @return
	 * @throws IOException
	 */
	
	public static svm_model svm_load_model(byte[] model) throws IOException
	{
		byte[] bytes = model;
		BufferedReader br = byteArray2Reader(bytes);
		return svm_load_model(br);
